...
📚 **Документация:** [k3rrX.github.io/cutelang](https://k3rrx.github.io/cutelang/)

## 👥 Команда

| Участник | Роль | Вклад |
|----------|------|-------|
| **Сысоева Кира** | Разработчик интерпретатора, документация | AST, интерпретатор (eval/apply), замыкания, GitHub Pages, документация |
...
├── examples/
│ ├── fact.cat           # Факториал
│ ├── fact_and_lists.cat # Факториал + списки
